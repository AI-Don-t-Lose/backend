...
아래와 같은 형식으로 JSON 형태로 응답해주세요(절대적으로 아래에 있는 규칙을 따르세요):
{
  ...
  "news": [
    {
      ...
      "summary": "최근 주식 관련 일반적인 시장 동향",
      "date": "2024-09-13"
    },
    {
      "link": "https://finance.naver.com",
      "summary": "해당 종목의 일반적인 업계 동향",
      "date": "2024-09-12"
    }
  ]
}
...
- 예시 내용이나 "(실제 내용으로 교체)" 같은 문구는 절대 사용 금지
- 가짜 뉴스 링크나 존재하지 않는 URL은 절대 생성하지 마세요
- 모든 내용은 완성된 실제 내용으로만 작성하세요`;
